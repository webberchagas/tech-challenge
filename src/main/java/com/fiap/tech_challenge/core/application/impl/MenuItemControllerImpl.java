...
import com.fiap.tech_challenge.core.domain.usecases.menu.*;
...
public class MenuItemControllerImpl implements MenuItemController {
    ...
    private final UpdateMenuItemCase updateMenuItemCase;
    ...
    @Override
    public MenuItemResponseDto updateMenuItemById(String id, MenuItemUpdateRequestDto request) {
        var menuItem = updateMenuItemCase.run(id, menuItemMapper.toDomain(request));
        return menuItemMapper.toResponseDto(menuItem);
    }
